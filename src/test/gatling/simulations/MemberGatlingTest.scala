...
class MemberGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Member entity")
        ...
        .repeat(2) {
            ...
            .post("/api/members")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "wxNo":"SAMPLE_TEXT", "personName":"SAMPLE_TEXT", "alias":"SAMPLE_TEXT", "persionMobile":"SAMPLE_TEXT", "gender":"0", "nature":"0", "provinceCode":"SAMPLE_TEXT", "cityCode":"SAMPLE_TEXT", "areaCode":"SAMPLE_TEXT", "address":"SAMPLE_TEXT"}""")).asJSON
            .check(status.is(201))
