...
class EventGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Event entity")
        ...
        .repeat(2) {
            ...
            .post("/api/events")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "title":"SAMPLE_TEXT", "startDate":"2020-01-01T00:00:00.000Z", "endDate":"2020-01-01T00:00:00.000Z", "status":"0", "picPath":"SAMPLE_TEXT", "summary":"SAMPLE_TEXT", "content":"SAMPLE_TEXT", "createTime":"2020-01-01T00:00:00.000Z"}""")).asJSON
            .check(status.is(201))
