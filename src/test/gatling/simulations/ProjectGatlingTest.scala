...
class ProjectGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Project entity")
        ...
        .repeat(2) {
            ...
            .post("/api/projects")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "compId":null, "compName":"SAMPLE_TEXT", "code":"SAMPLE_TEXT", "name":"SAMPLE_TEXT", "enName":"SAMPLE_TEXT", "supervisor":"SAMPLE_TEXT", "ownerContractor":"SAMPLE_TEXT", "totalContractor":"SAMPLE_TEXT", "startDate":"2020-01-01T00:00:00.000Z", "endDate":"2020-01-01T00:00:00.000Z", "status":"0", "delFlag":"0", "remark":"SAMPLE_TEXT", "extendAttr":"SAMPLE_TEXT"}""")).asJSON
            .check(status.is(201))
