...
class RoleGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Role entity")
        ...
        .repeat(2) {
            ...
            .post("/api/roles")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "name":"SAMPLE_TEXT", "code":"SAMPLE_TEXT", "level":"0", "parentId":null, "createdBy":"SAMPLE_TEXT", "createdDate":"2020-01-01T00:00:00.000Z", "lastModifiedBy":"SAMPLE_TEXT", "lastModifiedDate":"2020-01-01T00:00:00.000Z"}""")).asJSON
            .check(status.is(201))
